...
namespace VoxelBusters.EssentialKit.Editor.Android
{
    ...
    public class FirebaseSettingsGenerator
    {
        ...
        internal const string kGoogleServicesJsonPath                = "Assets/google-services.json";
        private const string kGoogleServicesGeneratedXmlFilePath    = Constants.kPluginAndroidProjectResValuesPath + "google-services.xml";
        private const string kGoogleServicesXmlTemplatePath         = Constants.kPluginAndroidEditorSourcePath + "google-services.template";

        static FirebaseSettingsGenerator()
		{
			Execute();
		}
        ...
        public static void Execute()
        {
            ...
            if (IsGoogleServicesJsonFileAvailable())
            {
                ...
                IDictionary googleServicesJsonContentMap    = (IDictionary)serializer.FromJson(googleServicesJsonContent);
