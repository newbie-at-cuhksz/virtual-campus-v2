...
namespace VoxelBusters.EssentialKit
{
    ...
    public class ShareItem 
    {
        ...
        public static ShareItem Text(string text)
        {
            ...
            if (text == null)
            {
                DebugLogger.LogWarning("Text is null.");
                return kInvalidItem;
            }
        ...
        public static ShareItem URL(URLString url)
        {
            ...
            if (!url.IsValid)
            {
                DebugLogger.LogWarning("Url is invalid.");
                return kInvalidItem;
            }
        ...
        public static ShareItem Image(Texture2D image, TextureEncodingFormat textureEncodingFormat, string fileName)
        {
            ...
            if (fileName == null)
            {
                DebugLogger.LogWarning("File name is null.");
                return kInvalidItem;
            }
        ...
        public static ShareItem File(byte[] data, string mimeType, string fileName)
        {
            ...
            if (data == null)
            {
                DebugLogger.LogWarning("Data is null.");
                return kInvalidItem;
            }
            if (mimeType == null)
            {
        ...
        public string GetText()
        {
            ...
            {
                DebugLogger.LogError("Invalid request.");
                return null;
            }
