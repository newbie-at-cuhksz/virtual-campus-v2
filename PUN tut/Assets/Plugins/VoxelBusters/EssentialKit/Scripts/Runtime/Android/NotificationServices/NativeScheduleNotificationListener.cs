...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeScheduleNotificationListener : AndroidJavaProxy
    {
        ...
        public NativeScheduleNotificationListener() : base("com.voxelbusters.android.essentialkit.features.notificationservices.INotificationServices$IScheduleNotificationListener")
        {
        }
