...
namespace VoxelBusters.EssentialKit.GameServicesCore.Android
{
    public class NativePlayerAuthenticationListener : AndroidJavaProxy
    {
        ...
        public NativePlayerAuthenticationListener() : base("com.voxelbusters.android.essentialkit.features.gameservices.IGameServices$IPlayerAuthenticationListener")
        {
        }
