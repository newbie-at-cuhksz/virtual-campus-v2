...
{
    public class NativePlayerSignoutListener : AndroidJavaProxy
    {
        #region Delegates
        ...
        public NativePlayerSignoutListener() : base("com.voxelbusters.android.essentialkit.features.gameservices.IGameServices$IPlayerSignoutListener")
        {
        }
