...
namespace VoxelBusters.EssentialKit.GameServicesCore.Android
{
    public class NativeLoadLocalPlayerScoreListener : AndroidJavaProxy
    {
        ...
        public NativeLoadLocalPlayerScoreListener() : base("com.voxelbusters.android.essentialkit.features.gameservices.IGameServices$ILoadLocalPlayerScoreListener")
        {
        }
