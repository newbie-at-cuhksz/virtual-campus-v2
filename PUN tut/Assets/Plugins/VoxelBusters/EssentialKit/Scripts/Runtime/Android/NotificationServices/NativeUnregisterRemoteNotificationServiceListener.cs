...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeUnregisterRemoteNotificationServiceListener : AndroidJavaProxy
    {
        ...
        public NativeUnregisterRemoteNotificationServiceListener() : base("com.voxelbusters.android.essentialkit.features.notificationservices.INotificationServices$IUnregisterRemoteNotificationServiceListener")
        {
        }
