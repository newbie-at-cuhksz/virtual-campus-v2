...
namespace VoxelBusters.EssentialKit.AddressBookCore.Android
{
    public class NativeRequestContactsPermissionListener : AndroidJavaProxy
    {
        ...
        public NativeRequestContactsPermissionListener() : base("com.voxelbusters.android.essentialkit.features.addressbook.IAddressBookHandler$IRequestContactsPermissionListener")
        {
        }
