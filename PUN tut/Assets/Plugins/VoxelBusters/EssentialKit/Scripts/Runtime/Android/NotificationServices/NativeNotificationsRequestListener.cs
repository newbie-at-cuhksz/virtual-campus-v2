...
namespace VoxelBusters.EssentialKit.NotificationServicesCore.Android
{
    public class NativeNotificationsRequestListener : AndroidJavaProxy
    {
        ...
        public NativeNotificationsRequestListener() : base("com.voxelbusters.android.essentialkit.features.notificationservices.INotificationServices$INotificationsRequestListener")
        {
        }
