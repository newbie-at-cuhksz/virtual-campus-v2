//
//  NPStoreReceiptServerVerificator.m
...
@implementation NPStoreReceiptServerVerificator

@synthesize customServerURLString   = _customServerURLString;
@synthesize sharedSecretKey         = _sharedSecretKey;

- (BOOL)useAppleItunesServer
{
    return ((self.customServerURLString == NULL) || (self.customServerURLString.length == 0));
}
